...
export const AGENTS = {
  ...
  '01-edmobot': { namespace: '01_EDMO', model: 'anthropic/claude-haiku-4-5', promptFile: '01-edmobot.txt', tier: 1, temperature: 0.15, maxContextTokens: 150000, maxHistoryTurns: 5, useScreenContext: false, contextQuery: 'coding backend Node.js Vapi work tasks Jira pull requests engineering', slackChannel: '#01-edmobot' },
