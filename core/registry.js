...
export const AGENTS = {
  ...
  '01-edmobot': { namespace: '01_EDMO', model: 'anthropic/claude-haiku-4-5', promptFile: '01-edmobot.txt', tier: 1, temperature: 0.15, maxContextTokens: 150000, maxHistoryTurns: 5, useScreenContext: false, contextQuery: 'coding backend Node.js Vapi work tasks Jira pull requests engineering email gmail gchat calendar meetings work conversations', slackChannel: '#01-edmobot' },
  ...
  '04-socialbot': { namespace: '04_SOCIAL', model: 'anthropic/claude-haiku-4-5', promptFile: '04-socialbot.txt', tier: 2, temperature: 0.5, maxContextTokens: 150000, contextQuery: 'WhatsApp iMessage Discord messages conversations social replies email gmail calendar personal messages', slackChannel: '#04-socialbot' },
