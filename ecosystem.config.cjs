...
function app(name) {
  return {
    ...
    env: {
      ...
      LANCEDB_LOG: process.env.LANCEDB_LOG || 'error',
      RUST_LOG: process.env.RUST_LOG || 'error',
      BRAIN_PATH: process.env.BRAIN_PATH || '~/hydra-brain',
      RUVECTOR_ENABLE: process.env.RUVECTOR_ENABLE || '1',
      RUVECTOR_DUAL_WRITE: process.env.RUVECTOR_DUAL_WRITE || '1',
      RUVECTOR_SHADOW_READ: process.env.RUVECTOR_SHADOW_READ || '1',
      RUVECTOR_READ_PRIMARY: process.env.RUVECTOR_READ_PRIMARY || '1',
    },
