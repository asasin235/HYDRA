---
name: debug-issue
description: Trace HYDRA failures through the agent stack, fix the root cause, validate, and log the result to Linear
allowed-tools:
  - Read
  - Bash
  - Edit
...
<objective>
Debug a HYDRA issue by tracing the agent execution path, implementing the root-cause fix, validating it, and syncing the result back to Linear.
</objective>
